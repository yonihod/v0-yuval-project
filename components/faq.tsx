        ...
        <div className="mx-auto max-w-3xl mt-12">
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="item-1">
              <AccordionTrigger className="text-right">מתי כדאי לבצע בדק בית?</AccordionTrigger>
            ...
            <AccordionItem value="item-2">
              <AccordionTrigger className="text-right">כמה זמן אורכת בדיקת בדק בית?</AccordionTrigger>
              <AccordionContent className="text-right">
            ...
            <AccordionItem value="item-3">
              <AccordionTrigger className="text-right">האם הדוח קביל בבית משפט?</AccordionTrigger>
              <AccordionContent className="text-right">
            ...
            <AccordionItem value="item-4">
              <AccordionTrigger className="text-right">מה כולל דוח בדק הבית?</AccordionTrigger>
              <AccordionContent className="text-right">
            ...
            <AccordionItem value="item-5">
              <AccordionTrigger className="text-right">האם אתם מבצעים גם בדיקות רטיבות?</AccordionTrigger>
              <AccordionContent className="text-right">
            ...
            <AccordionItem value="item-6">
              <AccordionTrigger className="text-right">האם כדאי להיות נוכח בזמן הבדיקה?</AccordionTrigger>
              <AccordionContent className="text-right">
