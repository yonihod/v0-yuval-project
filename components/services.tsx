...
const services = [
  ...
  },
  {
    ...
    title: "בדיקת אינדיקציה לרטיבות",
    description: "אבחון אינדיקציות לרטיבות בנכס",
    details: ["שימוש במצלמה טרמית ומד לחות מתקדמים לאבחון מדויק של אינדיקציות לרטיבות בנכס."]
  },
  {
